interface PostProps {
  ...
  time: string;
  content: string;
  images?: string[]; // El signo de interrogación significa que las imágenes son opcionales
}

export function Post({ avatar, name, time, content, images }: PostProps) {
  return (
    <div className="w3-container w3-card w3-white w3-round w3-margin"><br />
      ...
      {/* Renderizado condicional: si hay imágenes, las dibuja */}
